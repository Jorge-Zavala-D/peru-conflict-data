# M1-02.2 source-integrity receipt

Verification timestamp: `2026-08-27T23:14:37.8544197Z` (UTC). This was a
read-only PowerShell verification using literal paths and
`Get-FileHash -Algorithm SHA256`. No Dropbox file was created, edited, moved, or
removed.
...
All 11 sizes and hashes match the M0.1, M1-02, and M1-02.1 baselines. Their
combined size is 33,354,916 bytes. No external/raw source byte changed.

## Connected-root state

The connected Dropbox root contains exactly 82 directories, 111 files, and
33,453,193 bytes. The active derived layers remain empty:
...
The one-file difference from the 110-file M0/M1-02 baseline remains the benign
external archive delta `99_archive/.Rhistory`. It is zero bytes and hashes to the
empty-file SHA-256
`e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855`.
It is outside source/raw and active derived layers and was left untouched.

No file was added to `02_extracted` through `07_releases`, no operational
manifest was written to `01_raw/manifests/`, and no protected source or archive
file was modified. All live discovery receipts were written only beneath the
repository's ignored `.cache/` directory.
